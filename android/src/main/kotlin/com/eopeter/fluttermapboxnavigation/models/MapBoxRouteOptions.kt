...
class MapBoxRouteOptions : MapBoxParsable {
    ...
    override fun toJsonObject(): JsonObject {
        ...
        addProperty(json, "annotationsList", annotationsList)
        addProperty(json, "layersList", layersList)
        addProperty(json, "exclude", exclude)
        addProperty(json, "excludeList", excludeList)
        addProperty(json, "excludeObject", excludeObject)
        addProperty(json, "layersList", layersList)
        addProperty(json, "include", include)
        addProperty(json, "includeList", includeList)
        ...
        addProperty(json, "approachesList", approachesList)
        addProperty(json, "waypointIndices", waypointIndices)
        addProperty(json, "waypointIndicesList", waypointIndicesList)
        addProperty(json, "waypointNames", waypointNames)
        addProperty(json, "waypointNamesList", waypointNamesList)
        addProperty(json, "waypointTargets", waypointTargets)
        addProperty(json, "waypointTargetsList", waypointTargetsList)
        ...
        addProperty(json, "snappingIncludeClosuresList", snappingIncludeClosuresList)
        addProperty(json, "snappingIncludeStaticClosuresList", snappingIncludeStaticClosuresList)
        ...
        addProperty(json, "paymentMethodsList", paymentMethodsList)

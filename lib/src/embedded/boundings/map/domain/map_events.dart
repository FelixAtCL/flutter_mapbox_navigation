...
class MapEvent {
  ...
  /// ```
  static MapEvent mapLoaded = const MapEvent._('map-loaded');
  ...
  /// ```
  static MapEvent mapLoadingError = const MapEvent._('map-loading-error');
  ...
  /// Event data format (Object).
  /// ```
  static MapEvent mapIdle = const MapEvent._('map-idle');
  ...
  /// ```
  static MapEvent styleDataLoaded = const MapEvent._('style-data-loaded');
  ...
  ///
  static MapEvent styleLoaded = const MapEvent._('style-loaded');
  ...
  /// └── id - String
  /// ```
  static MapEvent styleImageMissing = const MapEvent._('style-image-missing');
  ...
  /// └── id - String
  /// ```
  static MapEvent styleImageRemoveUnused =
      const MapEvent._('style-image-remove-unused');
  ...
  ///     └── y Number (y coorinate)
  /// ```
  static MapEvent sourceDataLoaded = const MapEvent._('source-data-loaded');
  ...
  /// └── id - String
  /// ```
  static MapEvent sourceAdded = const MapEvent._('source-added');
  ...
  /// └── id - String
  /// ```
  static MapEvent sourceRemoved = const MapEvent._('source-removed');

  /// The `map` started rendering a frame.
  ///
  /// Event data format (Object).
  static MapEvent renderFrameStarted = const MapEvent._('render-frame-started');
  ...
  /// ```
  static MapEvent renderFrameFinished =
      const MapEvent._('render-frame-finished');
  ...
  /// Event data format (Object).
  /// ```
  static MapEvent cameraChanged = const MapEvent._('camera-changed');
  ...
  /// └── cancelled - Boolean
  /// ```
  static MapEvent resourceRequest = const MapEvent._('resource-request');

  final String name;

  const MapEvent._(this.name);
}
